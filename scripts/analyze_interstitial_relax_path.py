...
(args, models, bulk_tests, default_analysis_settings) = analyze_start('interstitial_relax_path')
...
for model_name in sorted(models):
    if bool(data[model_name]["interstitial_relax_path"]["energy"]) == True:
        E = data[model_name]["interstitial_relax_path"]["energy"]
...
ylim([-5, 60])
legend()
savefig("interstitial_relax_path.pdf", bbox_inches='tight')
