...
(args, models, bulk_tests, default_analysis_settings) = analyze_start('interstitial')
...
for model_name in sorted(models):
    if bool(data[model_name]["interstitial"]["energy"]) == True:
        E = data[model_name]["interstitial"]["energy"]
        E_shift = [ e - min(E) for e in E]
...
#ylim([-605, -590])
legend()
savefig("interstitial.pdf", bbox_inches='tight')
